        ...
        <div className={styles.heroInner}>
          <div className={styles.heroText}>
            ...
            <p className={styles.heroDesc}>
              Relate um animal avistado ou anuncie seu pet perdido.
      ...
      <section className={styles.feedSection}>
        <div className="container">
          <div className={styles.sectionHeader}>
            <div>
              <h2 className="section-title">Animais avistados recentemente</h2>
          ...
          {loading ? (
            ...
            <Empty icon="🔍" title="Nenhum relato ainda" description="Seja o primeiro a relatar um animal avistado!" />
          ) : (
